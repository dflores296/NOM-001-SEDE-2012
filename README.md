...
| Tablas contrastadas contra el PDF | 223 |
...
- [x] **Fase 4.5** — Las 223 tablas contrastadas celda por celda contra el PDF
...
### La revisión a mano: 223 de 223

**El reparto automático llegó hasta donde llega, así que las 223 tablas se
...
Contrastar 223 tablas celda por celda contra el PDF no fue barato, y
...
1. **Las 223 están congeladas.** Cada entrada de `data/tablas_revisadas.json`
...
alguno y el detector no puede ver porque no hay título que detectar. De ahí que
el total sea 223 y no 220.
