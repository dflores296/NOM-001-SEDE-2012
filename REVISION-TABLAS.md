...
## 1 · Prioridad alta — reconstrucción insegura (34)

Calidad por debajo de 0.80: hay celdas con varios valores juntos, señal de que la
separación en columnas falló en alguna fila.
...
| [ ] | `310-60(c)(67)` | Ampacidad permisible de cables monoconductores de cobre ai | 143 | 1 | 0.68 | **huecos** | 18×3 |
| [ ] | `355-30` | Soportes para tubo conduit de resina termofija reforzada ( | 201, 202 | 1 | 0.68 | **huecos** | 7×4 |
| [ ] | `326-24` | Radio mínimo de curvatura | 177 | 1 | 0.70 | **huecos** | 5×2 |
| [ ] | `922-93(a)(1)` | Tamaño mínimo de conductores de cobre | 725 | 1 | 0.73 | **huecos** | 5×3 |
| [ ] | `922-12(a)(1)` | Separación horizontal mínima entre conductores(1) | 709 | 3 | 0.77 | dibujada | 15×2 |
| [ ] | `326-112` | Espesor del papel separador | 177 | 1 | 0.56 | dibujada | 3×3 |
| [ ] | `310-15(b)(7)` | Tipos y tamaño o designación de conductores para alimentad | 137 | 1 | 0.78 | **huecos** | 14×4 |
| [ ] | `110-34(e)` | Altura de las partes vivas sin proteger sobre el espacio d | 27 | 1 | 0.78 | **huecos** | 4×3 |
...
## 2 · Sin rejilla dibujada en el PDF (40)

El PDF no dibuja las líneas de estas tablas, así que las columnas se dedujeron de los
huecos entre palabras. La calidad sale alta porque no hay números pegados, pero **no
se recuperan celdas combinadas** y una columna puede estar corrida. Son las que más
conviene mirar con calma aunque no estén marcadas.
...
| [ ] | `680-10` | Profundidad mínima del recubrimiento | 572 | 1 | 0.93 | **huecos** | 7×2 |
| [ ] | `922-43` | Altura sobre el suelo de partes vivas de equipo instalado | 718 | 1 | 0.93 | **huecos** | 5×6 |
| [ ] | `440-3(d)` | Otros artículos | 327 | 1 | 0.94 | **huecos** | 6×4 |
| [ ] | `220-88` | Método opcional - Cálculos de la carga permitida para los | 53 | 1 | 0.95 | **huecos** | 5×4 |
| [ ] | `450-3(a)` | Valor nominal o ajuste máximo de la protección contra sobr | 335, 336 | 1 | 0.97 | **huecos** | 14×4 |
| [ ] | `392-10(a)` | Métodos de alambrado | 229 | 2 | 0.99 | **huecos** | 35×2 |
| [ ] | `225-3` | Otros Artículos | 54, 55 | 1 | 0.98 | **huecos** | 25×2 |
| [ ] | `240-3` | Otros artículos | 71, 72 | 2 | 0.99 | **huecos** | 36×3 |
| [ ] | `310-60(c)(74)` | Ampacidad de cables de tres conductores o ternas de cables | 146, 147 | 0 | 0.98 | **huecos** | 17×6 |
| [ ] | `310-60(c)(76)` | Ampacidad de cables de tres conductores de aluminio aislad | 147, 148 | 0 | 0.98 | **huecos** | 17×6 |
| [ ] | `250-3` | Requisitos adicionales de unión y puesta a tierra | 84, 85 | 1 | 0.99 | **huecos** | 52×3 |
...
| [ ] | `310-60(c)(68)` | Ampacidad de cables de ternas de conductores individuales | 143, 144 | 1 | 1.00 | **huecos** | 17×6 |
| [ ] | `310-104(b)` | Espesor del aislamiento para conductores no blindados de t | 157 | 2 | 1.00 | **huecos** | 10×6 |
...
comprobar dos o tres renglones de cada una.
